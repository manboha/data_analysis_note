...
\hypersetup{
  pdftitle={Exploratory Data Analysis Note},
  pdfauthor={Manboha},
  colorlinks=true,
  linkcolor=Maroon,
  filecolor=Maroon,
...
\title{Exploratory Data Analysis Note}
\usepackage{etoolbox}
\makeatletter
...
\tightlist
\item
  Rafael A. Irizarry, ``Introduction to Data Science'', \url{https://rafalab.github.io/dsbook/}
\item
  Pablo Casas, ``Data Science Live Book'', \url{https://livebook.datascienceheroes.com/}
\item
  Zach Bogart and Joyce Robbins, ``edav.info/'', \url{https://edav.info/index.html}
\item
  Rob Kabacoff, ``Data Visualization with R'', \url{https://rkabacoff.github.io/datavis/}
\item
  Hadley Wickham and Garrett Grolemund, ``R for Data Science'', \url{https://r4ds.had.co.nz/index.html}
\end{itemize}
